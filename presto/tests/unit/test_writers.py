...
from presto.loss import LossRecord
from presto.writers import report, write_scatter
...
class TestOpenWriter:
    ...
    def test_open_writer_creates_directory(self, tmp_path):
        ...
        from presto.writers import open_writer
...
class TestWriteMetrics:
    ...
    def test_write_metrics_writes_to_file(self, tmp_path):
        ...
        from presto.writers import open_writer, write_metrics
...
class TestPotentialSummary:
    ...
    def test_get_potential_summary_returns_string(self):
        ...
        from presto.writers import get_potential_summary
