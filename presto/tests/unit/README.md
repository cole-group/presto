"""
Comprehensive Unit Tests for presto
=============================================

This test suite provides comprehensive unit tests for the presto package.
...
```bash
pixi run pytest -v --cov=presto --cov-report=html presto/tests/unit
```

To run specific test files:
```bash
pixi run pytest presto/tests/unit/test_settings.py -v
```
...
```bash
pixi run pytest presto/tests/unit/test_settings.py::TestWorkflowSettings -v
```
